...
(function (factory) {
    ...
    Typeahead.prototype = {
        ...
        unifySourceFormat: function () {
            ...
            // source: "https://www.test.com/url.json"
            ...
            // source: {data: ['item1', 'item2'], url: "https://www.test.com/url.json"}
            ...
            for (group in this.options.source) {
                ...
                // source: {group: "https://www.test.com/url.json"}
                ...
                // source: {group: {url: ["https://www.test.com/url.json", "json.path"]}}
                ...
                if (Array.isArray(tmpAjax)) {
                    ...
                    // source: {group: {url: {url: "https://www.test.com/url.json", method: "GET"}}}
                    // source: {group: {url: "https://www.test.com/url.json", dataType: "jsonp"}}
